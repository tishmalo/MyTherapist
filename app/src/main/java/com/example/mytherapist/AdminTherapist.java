...
import com.example.mytherapist.Adapter.VerifyTherapistAdapter;
...
public class AdminTherapist extends AppCompatActivity {
    ...
    private VerifyTherapistAdapter userAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_therapist);
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                userAdapter= new VerifyTherapistAdapter(AdminTherapist.this, userList);
