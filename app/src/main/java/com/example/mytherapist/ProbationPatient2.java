...
public class ProbationPatient2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_probation_patient2);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                userDatabaseRef.updateChildren(userinfo).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            Toast.makeText(ProbationPatient2.this, "Identity updated", Toast.LENGTH_SHORT).show();
                            ...
                            if (resulturi != null) {
                                ...
                                uploadTask.addOnFailureListener(new OnFailureListener() {
                                    ...
                                    public void onFailure(@NonNull Exception e) {
                                        Toast.makeText(ProbationPatient2.this, "Upload failed", Toast.LENGTH_SHORT).show();
                                            ...
                                            result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    ...
                                                    userDatabaseRef.updateChildren(getimagemap).addOnCompleteListener(new OnCompleteListener() {
                                                        ...
                                                        public void onComplete(@NonNull Task task) {
                                                            if (task.isSuccessful()) {
                                                                Toast.makeText(ProbationPatient2.this, "Image uploaded successfuly", Toast.LENGTH_SHORT).show();
                                                            } else {
                                                                Toast.makeText(ProbationPatient2.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                                                            }
                ...
                Intent intent30= new Intent(ProbationPatient2.this, PatientPage.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode ==1 ) {
            ...
            Glide.with(ProbationPatient2.this).load(resulturi).into(profilepic);
