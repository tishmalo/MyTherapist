...
import com.example.mytherapist.TherapistReviews;
...
public class VerifyPatient extends RecyclerView.Adapter<VerifyPatient.ViewHolder> {

    private Context context;
    private List<TherapistList> userList;

    public VerifyPatient(Context context, List<TherapistList> userList) {
